...
export const META = {
  asOf: "2026-08-06",
  build: "v80 · 2026-08-06", // bump on each change so the footer confirms the live build
  currency: "GBP",
  disclaimer:
...
export const RATES = {
  ...
  // re-verified this run directly against the BoE IADB (IUMBV37 60% LTV 4.76%,
  // IUMBV34 75% LTV 4.81%, both 30 Jun 2026 — no Jul/Aug month-end point yet) —
  // interpolated 70% ≈4.79%, correcting the prior stale/miscalculated 5.02%.
