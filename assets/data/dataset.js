...
export const META = {
  asOf: "2026-07-16",
  build: "v38 · 2026-07-16", // bump on each change so the footer confirms the live build
  currency: "GBP",
  disclaimer:
...
export const COMPARABLES = {
  ...
  note:
    ...
    "Islington FLATS fell 6.1% in value over the year to April 2026 (per HM Land Registry/ONS), a " +
    "sharper drop than the borough's all-property average. The N1 7TX postcode 12-month average " +
    "sold price is ~£575k — but N1 7TX is effectively a single building with unit sizes from 1- to " +
    "3-bed, so this average swings a lot with the sales mix and isn't a like-for-like comp on its " +
    "own. Your flat is a 2020-built 2-bed/2-bath of 91.45 m², which typically sits in the upper half " +
    "of the £/m² range (new-build premium, maturing with age).",
  ...
  n1_7txAvg12m: 575000, // your postcode, last 12 months — small-sample, mixed unit sizes
};
...
export const COMPS = {
  ...
  rows: [
    { addr: "Mono Tower, Penn Street, N1 5", date: "2026-04", price: 842000, beds: 2, baths: 2, type: "Apartment — new build", sqm: 76, lat: 51.5364, lng: -0.0863 },
    { addr: "Packington Square, N1 7", date: "2026-03", price: 745000, beds: 2, baths: 2, type: "Apartment — purpose-built", sqm: 93, lat: 51.5355, lng: -0.0954 },
...
export const PRICE_HISTORY = {
  ...
  note:
    "Islington FLATS (the segment closest to your flat) fell 6.1% over the year to April 2026, per " +
    "HM Land Registry/ONS — a sharp downgrade from the ~flat reading in the March release. " +
    "Islington's all-property average price fell too: £703k (Apr 2025, revised) → £665k (Apr 2026), " +
    "-5.4%. London-wide -2.1%. Index is anchored to your purchase month so 100 = £890,000.",
  ...
  series: [
    ...
    { date: "2026-04", islington: 93.9, london: 97.9 }, // Islington flats -6.1% YoY, London -2.1% (unchanged)
  ],
};
...
export const ISLINGTON_FACTS = {
  ...
  yoyPct: -5.4,
  flatsYoY: -6.1, // Islington flat/maisonette average, year to Apr 2026 (£553k)
...
export const RATES = {
  ...
  swap2yrPrev: 4.23, // ~prior day (MFB), so the badge's day-over-day % change stays meaningful
  ...
  fix2yrSeries: [
    ...
    { date: "2026-07", rate: 5.52 }, // 2yr/5yr fixes now roughly level
  ],
...
export const FORECAST = {
  ...
  note:
    ...
    "near-term but Savills models ~13.6% cumulative London growth 2026–2030.",
