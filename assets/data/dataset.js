...
// -----------------------------------------------------------------------------
// Every figure below is a snapshot researched on 2026-07-20. Each block carries a
...
export const META = {
  asOf: "2026-07-20",
  build: "v38 · 2026-07-20", // bump on each change so the footer confirms the live build
  currency: "GBP",
  disclaimer:
...
export const SOURCES = {
  ...
  moneyfactsRates: {
    label: "Moneyfacts UK Mortgage Trends Treasury Report (via Mortgage Solutions)",
  ...
  swapRateBlueGamma: {
    label: "BlueGamma — UK SONIA swap rates (2-year)",
...
export const COMPARABLES = {
  ...
  note:
    ...
    "Islington flat prices fell 6.1% year-on-year to April 2026 (Land Registry HPI), reversing the " +
    "roughly-flat picture in the March release — largely a base effect against an unusually strong " +
    "April 2025 (likely tied to stamp-duty-deadline distortion). The N1 7TX postcode 12-month average " +
    "sold price remains ~£1.07m. Your flat is a 2020-built 2-bed/2-bath of 91.45 m², which typically " +
    "sits in the upper half of the range (new-build premium, maturing with age).",
...
export const COMPS = {
  ...
  rows: [
    ...
    { addr: "Duo Tower, Penn Street, N1 5", date: "2026-04", price: 765000, beds: 2, baths: 2, type: "Apartment — purpose-built", sqm: 75, lat: 51.536316, lng: -0.08569 },
  ],
};
...
export const PRICE_HISTORY = {
  source: "hpiApr2026",
  note:
    "Islington average price £673k (Mar 2025, revised) → £665k (Apr 2026) — about -1.2% versus your " +
    "purchase-anchor. Year-on-year the swing looks sharper (Islington -5.4%, flats -6.1% to Apr 2026) " +
    "mainly because April 2025 was an unusually high base (likely a stamp-duty-deadline distortion " +
    "around the March 2025 nil-rate-band reversion) — the April 2026 release is the newest published. " +
    "London-wide held at -2.1% YoY, unchanged in pace from the March release. Index is anchored to " +
  ...
  series: [
    ...
    { date: "2026-04", islington: 98.8, london: 97.8 }, // April 2026 HPI release (latest published; May due 2026-07-22)
  ],
};
...
export const RATES = {
  ...
  // No free live feed for this — manually refreshed from a broker/aggregator quote.
  swap2yrNow: 4.18,
  ...
  // Average market fixes, July 2026 (Moneyfacts UK Mortgage Trends Treasury Report)
  avg2yrFix: 5.52,
  avg5yrFix: 5.52,
  fix2yrSeries: [
    ...
    { date: "2026-07", rate: 5.52 }, // Moneyfacts, start-of-July snapshot reported 2026-07-13
  ],
